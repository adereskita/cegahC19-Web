<nav class="navbar navbar-light navbar-expand fixed-top bg-nav-shadow">
    <div class="container-fluid"><button class="btn open-btn" type="button"><i class="fas fa-bars"></i></button><button
...
<div class="side bg-slider">
    <div class="bg-light p-3"><img class="img-brand-admin" src="../assets/img/brand.png"><button
